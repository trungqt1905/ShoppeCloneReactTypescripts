...
import { Schema, loginSchema } from 'src/untils/rules'
import { isAxiosUnprocessableEntityErrors } from 'src/untils/untils'

type Inputs = Omit<Schema, 'confirmPassword'>
...
export default function Login() {
  ...
  const loginAccountMutation = useMutation({
    mutationFn: (body: Omit<Inputs, 'confirmPassword'>) => loginAccount(body)
  })
  ...
  const onSubmit = handleSubmit((data) => {
    loginAccountMutation.mutate(data, {
      ...
      onError: (error) => {
        if (isAxiosUnprocessableEntityErrors<ResponseApi<Inputs>>(error)) {
